...
//    }
    ...
    //连接
    public void connect(MqttAndroidClient mqttAndroidClient, Context context,String serverURI, String clientId, String TAG, int SW, String msg,String topic) {
        ...
        try {
            ...
            mqttAndroidClient.connect(connectOptions, null, new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    ...
                    if (SW==1)
                    {
                        publish(finalMqttAndroidClient,msg,topic,TAG);
                    }
